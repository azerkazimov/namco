...
import ChalcopyriteOre3D from "@/components/ui/3d-ore-chalcopyrite";

export default function ChalcopyriteOreTypes() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h2 className="text-4xl lg:text-6xl font-bold text-black mb-4">
            <span className="font-normal">CHALCOPYRITE</span>
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <div className="p-8 space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Chalcopyrite ore is a type of ore that is used to make chalcopyrite. Chalcopyrite is a
                metal that is used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite. Chalcopyrite is also used in the production of chalcopyrite.
              </p>
